...
public class AuditionLogger {
    ...
    private String createStandardProblemDetailMessage(final ProblemDetail standardProblemDetail) {
        ...
        return String.format("ProblemDetail [status=%s, title=%s, detail=%s]",
            standardProblemDetail.getStatus(),
            StringUtils.defaultString(standardProblemDetail.getTitle()),
            StringUtils.defaultString(standardProblemDetail.getDetail()));
    }
